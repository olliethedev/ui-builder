...
function getDependencies(type: RegistryType): string[] {
    switch (type) {
        case "registry:ui":
            return ["@anatine/zod-mock", "react-error-boundary", "react-hook-form", "swapy", "zod", "zustand", "zundo", "immer", "fast-deep-equal", "next-themes", "react-markdown", "remark-gfm", "remark-math", "react-syntax-highlighter", "@types/react-syntax-highlighter", "lodash.template", "@types/lodash.template"];
        case "registry:lib":
