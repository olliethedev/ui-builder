...
const registryConfigs: RegistryConfig[] = [
  {
    ...
    targetFunction: (path: string) =>
      path.replace("components/ui/ui-builder", "components/ui/ui-builder"),
  },
  {
    type: "registry:lib",
    path: "./lib/ui-builder/**/*",
    targetFunction: (path: string) =>
      path.replace("lib/ui-builder", "lib/ui-builder"),
  },
  {
    type: "registry:hook",
    path: "./hooks/**/*",
  ...
  },
  {
    ...
    targetFunction: (path: string) =>
      path.replace("app/example", "/app/ui-builder"),
  },
  {
    type: "registry:ui",
...
async function buildRegistry() {
  ...
  console.log(registryFileName, "registryFileName");
...
function getRegistryDependencies(): string[] {
  return [
    "https://raw.githubusercontent.com/vantezzen/autoform/refs/heads/pure-shadcn/registry/auto-form.json",
