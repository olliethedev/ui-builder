export const TAILWIND_CLASSES = [
    ...
    "bg-popover","bg-popover-foreground","bg-card","bg-card-foreground","bg-border","bg-input","bg-ring","bg-background","bg-foreground","text-primary","text-primary-foreground","text-secondary","text-secondary-foreground",
    ...
    "text-border","text-input","text-ring","text-background","text-foreground","border-primary","border-primary-foreground","border-secondary","border-secondary-foreground","border-destructive","border-destructive-foreground",
...
export const TAILWIND_CLASSES_WITH_BREAKPOINTS = [
    "","md:",//"sm:","lg:","xl:","2xl:"
].flatMap(bp => TAILWIND_CLASSES.map(cls => `${bp}${cls}`))